      ...
      <div>
        ...
        >
          ...
          <p className="text-gray-400 my-4 dark:text-white text-[22px]">
            Here are some of the skill I've. I hope it will meet your
            requirements.
          </p>
        </motion.div>
          ...
          <div className="grid 2xl:grid-cols-5 lg:grid-cols-4 grid-cols-3 gap-8 uppercase">
            ...
            >
              <svg
                ...
                height="64"
                viewBox="0 0 32 32"
                className="md:w-[70px] md:h-[70px] w-[60px] h-[60px] lg:w-[80px] lg:h-[80px] mb-3"
              >
                <path
            ...
            >
              <svg
                ...
                className="md:w-[150px] md:h-[80px] w-[120px] h-[60px] lg:w-[160px] lg:h-[85px] mb-3"
              >
                <path
