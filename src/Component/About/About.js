    ...
    return (
        ...
        >
            <div className='text-left flex-1 xl:ml-[80px] md:ml-[40px]'>
                <div className='flex gap-1 items-center'>
                    ...
                    >
                        ...
                        <TypeAnimation
                            sequence={[' Pham Dinh Duy', 4000, '  Pham Dinh Duy', 4000, '   Pham Dinh Duy', 4000]}
                            speed={50}
                            repeat={Infinity}
                ...
                <div className=' grid grid-cols-2 gap-6 items-center mt-12 2xl:text-[20px] dark:text-white'>
                    <motion.a
                        ...
                        whileInView={'show'}
                        viewport={{ once: true, amount: 0.7 }}
                        href={`mailto:${profile?.email || 'phamdinhduy1502@gmail.com'}`}
                    ...
                    >
                        ...
                        <div className=''>
                            ...
                            <p className='text-gray-500 dark:text-white'>
                                {profile?.email || 'phamdinhduy1502@gmail.com'}
                            </p>
                        </div>
                    </motion.a>
                    <motion.a
                        ...
                        whileInView={'show'}
                        viewport={{ once: true, amount: 0.7 }}
                        href={`tel:${profile?.phoneNumber || '(+84) 366 010 143'}`}
                        className='flex gap-2 items-center'
                    >
                        <div className='p-3 text-[20px] shadow-xl rounded-[8px]  h-full  uppercase'>
                            <AiFillMobile />
                        ...
                        <div className=''>
                            ...
                            <p className='text-gray-500 dark:text-white'>
                                {profile?.phoneNumber || '(+84) 366 010 143'}
                            </p>
                        </div>
                    </motion.a>
                    <motion.a
                        ...
                        whileInView={'show'}
                        viewport={{ once: true, amount: 0.7 }}
                        href={`https://${profile?.githubUrl || 'github.com/DinhDuyPham'}`}
                        target='_blank'
                        rel='noreferrer'
                        className='flex gap-2 items-center'
                    >
                        ...
                        <div className=''>
                            ...
                            <p className='text-gray-500 dark:text-white'>
                                /{profile?.githubUrl?.split('com/')[1] || 'DinhDuyPham'}
                            </p>
                        </div>
                    </motion.a>
                    <motion.a
                        ...
                        whileInView={'show'}
                        viewport={{ once: true, amount: 0.7 }}
                        href={`https://${profile?.facebookUrl || 'facebook.com/phamdinhduy1502'}`}
                        target='_blank'
                        className='flex gap-2 items-center'
                        rel='noreferrer'
                    >
                        ...
                        <div className=''>
                            ...
                            <p className='text-gray-500 dark:text-white'>
                                /{profile?.facebookUrl?.split('com/')[1] || 'phamdinhduy1502'}
                            </p>
                        </div>
                    </motion.a>
                </div>
            ...
            >
                <img
                    loading='lazy'
                    src={profile?.aboutImage || require('../../assets/images/aboutImg.jpg')}
                    alt=''
